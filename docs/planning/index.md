...
| MVP-4: runtime.run() → prompt        | coreai-0ga | in progress | [constraints](./beads-mvp-alignment-v3.md#e11-coreai-0ga) | 21/03/2026 |
| MVP-5: Plugin contract — memory-only | coreai-9ts | in progress | [constraints](./beads-mvp-alignment-v3.md#e11-coreai-9ts) | 21/03/2026 |
